...
public class DebugTransformer implements ClassFileTransformer {
	...
	static {
		methodList.add("com.agent.agent_vm_test.MyTest.sayHello");
		methodList.add("com.agent.agent_vm_test.MyTest.sayHello2");
	}
	...
	public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws IllegalClassFormatException {
		...
		if (className.startsWith("com/agent/agent_vm_test")) {
