...
public class InvokeAfterCodeGenerator extends InvokeCodeGenerator {
    ...
    public InvokeAfterCodeGenerator(int interceptorId, InterceptorDefinition interceptorDefinition, InstrumentClass targetClass, InstrumentMethod targetMethod, boolean localVarsInitialized, boolean catchClause) {
